...
import_wgEncodeRegTfbsClusteredV2 <- function(ahroot) # v2?
{
    ...
    params$Url <- "http://hgdownload.cse.ucsc.edu/goldenpath/hg19/encodeDCC/wgEncodeRegTfbsClustered/wgEncodeRegTfbsClusteredV2.bed.gz"
...
import_stamConnectivity <- function(ahroot)
{
    params <- bedCommon()
    params$AnnotationHubRoot <- ahroot
    params$OriginalFile <- "pub/databases/ensembl/encode/supplementary/integration_data_jan2011/byDataType/openchrom/jan2011/dhs_gene_connectivity/genomewideCorrs_above0.7_promoterPlusMinus500kb_withGeneNames_32celltypeCategories.bed8.gz"
    ...
    params$Url <- "ftp://ftp.ebi.ac.uk/pub/databases/ensembl/encode/supplementary/integration_data_jan2011/byDataType/openchrom/jan2011/dhs_gene_connectivity/genomewideCorrs_above0.7_promoterPlusMinus500kb_withGeneNames_32celltypeCategories.bed8.gz"
...
import_stamFootprints <- function(ahroot)
{
    params <- bedCommon()
    params$AnnotationHubRoot <- ahroot
    params$OriginalFile <- "pub/databases/ensembl/encode/supplementary/integration_data_jan2011/byDataType/footprints/jan2011/all.footprints.gz"
    ...
    params$Url <- "ftp://ftp.ebi.ac.uk/pub/databases/ensembl/encode/supplementary/integration_data_jan2011/byDataType/footprints/jan2011/all.footprints.gz"
    params$SourceVersion <- "unknown"
    params$Maintainer <- "Paul Shannon <pshannon@fhcrc.org>"
    params$Tags <- "gene regulation"
    x <- do.call(AnnotationHubMetadata, params)
...
import_stamH3K4me3ProfilePromoters <- function(ahroot)
{
    ...
    params$Title <- "DNase1 footprints from the stamlab"
    params$Description <- "45M subsites within DNase1 sensitivity regions, presumed to be transcription factor binding sites"
    params$Url <- c("ftp://ftp.ebi.ac.uk/pub/databases/ensembl/encode/supplementary/integration_data_jan2011/byDataType/openchrom/jan2011/promoter_predictions/master_known.bed",
...
import_wgEncodeRikenCageCd20CellPapTssHmm <- function(ahroot)
{
    ...
    params$Url <- "http://hgdownload.cse.ucsc.edu/goldenpath/hg19/encodeDCC/wgEncodeRikenCage/wgEncodeRikenCageCd20CellPapTssHmm.bedRnaElements"
    params$SourceVersion <- "unknown"
    params$Maintainer <- "Paul Shannon <pshannon@fhcrc.org>"
    params$Tags <- "gene regulation"
...
import_wgEncodeRikenCageCd34mobilizedCellPapTssHmm <- function(ahroot)
{
    params <- bedCommon()
    params$AnnotationHubRoot <- ahroot
    params$OriginalFile <- "goldenpath/hg19/encodeDCC/wgEncodeRikenCage/wgEncodeRikenCageCd34mobilizedCellPapTssHmm.bedRnaElements"
    ...
    params$Url <- "http://hgdownload.cse.ucsc.edu/goldenpath/hg19/encodeDCC/wgEncodeRikenCage/wgEncodeRikenCageCd34mobilizedCellPapTssHmm.bedRnaElements"
    params$SourceVersion <- "unknown"
    params$Maintainer <- "Paul Shannon <pshannon@fhcrc.org>"
...
import_wgEncodeRikenCageMonocd14CellPapTssHmm <- function(ahroot)
{
    params <- bedCommon()
    params$AnnotationHubRoot <- ahroot
    params$OriginalFile <- "goldenpath/hg19/encodeDCC/wgEncodeRikenCage/wgEncodeRikenCageMonocd14CellPapTssHmm.bedRnaElements"
    ...
    params$Url <- "http://hgdownload.cse.ucsc.edu/goldenpath/hg19/encodeDCC/wgEncodeRikenCage/wgEncodeRikenCageMonocd14CellPapTssHmm.bedRnaElements"
    params$SourceVersion <- "unknown"
    params$Maintainer <- "Paul Shannon <pshannon@fhcrc.org>"
    params$Tags <- "gene model"
    params$Notes <- paste("9 total columns in the bed file, 8 of which are presented here ('empty' is omitted)",
