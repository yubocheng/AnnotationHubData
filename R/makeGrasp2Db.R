## STEP 1 & 2 have been moved back to the grasp2db package.
...
##         Coordinate_1_based = FALSE)) ## Hope you are sure (default is TRUE)
## }
...
## For now, I have left the functions in grasp2db unexported as they are not really meant for public use (only meant to be used by the hub here...
