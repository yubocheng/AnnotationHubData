...
Individual objects of a standard class, e.g., a single TxDb, OrgDb, or BSgenome
can be added by providing the data and metadata to a `Bioconductor` team member
instead of creating a package as described in the `Family of Resources`
section.
...
* man/
  ...
  - resource man pages: 
    ...
    eh <- AnnotationHub()
    myfiles <- query(eh, "SEARCHTERM1", "SEARCHTERM2")
