...
* filtering: this is normally TRUE to indicate that we don't want to regenerate AHMs for records that are already in the local cached database.  However, you sometimes may want to set this to FALSE if you need to do some testing.
