...
scp ubuntu@annotationhub.bioconductor.org:/home/ubuntu/AnnotationHubDumps/dbdump_2014_11_06_fromProd.sql.gz .
```

And then unpack it (use the MySQL root password for this):
...
#### And: final test that it works on gamay
